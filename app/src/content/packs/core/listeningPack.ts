...
const items: ContentItem[] = [
  ...
  { id: 'jump', en: 'jump', he: 'קפוץ', visual: { kind: 'text', he: '🦘' } },
  { id: 'run', en: 'run', he: 'רוץ', visual: { kind: 'text', he: '🏃' } },
  { id: 'stop', en: 'stop', he: 'עצור', visual: { kind: 'text', he: '🛑' } },
  ...
  { id: 'look', en: 'look', he: 'תסתכל', visual: { kind: 'text', he: '👀' } },
  { id: 'sit', en: 'sit', he: 'שב', visual: { kind: 'text', he: '🪑' } },
  { id: 'stand', en: 'stand', he: 'עמוד', visual: { kind: 'text', he: '🧍' } },
];
