...
const items: ContentItem[] = [
  ...
  { id: 'bye', en: 'bye', he: 'ביי', visual: { kind: 'text', he: '➡️👋' } },
  { id: 'yes', en: 'yes', he: 'כן', visual: { kind: 'text', he: '✅' } },
  { id: 'no', en: 'no', he: 'לא', visual: { kind: 'text', he: '❌' } },
  {
    id: 'please',
    en: 'please',
    he: 'בבקשה',
  ...
  // Emotions
  { id: 'happy', en: 'happy', he: 'שמח', visual: { kind: 'text', he: '😀' } },
  { id: 'sad', en: 'sad', he: 'עצוב', visual: { kind: 'text', he: '😢' } },
  { id: 'angry', en: 'angry', he: 'כועס', visual: { kind: 'text', he: '😠' } },
  {
    id: 'scared',
    en: 'scared',
    he: 'מפחד',
  ...
  { id: 'tired', en: 'tired', he: 'עייף', visual: { kind: 'text', he: '🥱' } },
  { id: 'calm', en: 'calm', he: 'רגוע', visual: { kind: 'text', he: '😌' } },
];
